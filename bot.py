...
@app.on_message(filters.command(azan_commands)|filters.regex('ت+ش+ن+م+')|filters.regex('گ+ش+ن+م+'))
...
@app.on_message(filters.regex('گ+ش+ن+ت+ه+')|filters.regex('ت+ش+ن+ت+ه+'))
